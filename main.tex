...
instead the task consist in separating the data among an \textit{a priori} unknown number of classes whose members share similar features \cite{bishop2006pattern}.
...
there are no labelled data and no specific task \cite{krotov2019unsupervised}.
