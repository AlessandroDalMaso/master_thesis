...
\begin{figure} [H]
    ...
    \caption{Emerging pattern in a backpropagation network. \todo[inline]{manca contesto, questi sono i risultati per la rete neurale anche in input? (non ho capito)}}
    \label{backnet}
\end{figure}
...
\todo[inline]{var vedere i risultati in questo caso (ma non cambia nulla)}
...
The value used for $\epsilon$ was 0.05. \todo[inline]{con altri valori che cosa si ottiene? (se metto anche i risultati, con quale criterio?) (nota per me: ho già l'illustrazione con 0.02)}
...
All clusters can be visualized in the appendix. \todo[inline]{mettere i numeri ai cluster in modo da capire come si agglomerano (ma non ci sono già?)}
